// // services/PaymentService/index.js
...
//     const PaymentHistory = require("../../entities/PaymentHistory");
//     const debtService = require("../DebtService");
//     const interestService = require("../InterestAccrualService");
//     const paymentRepo = this._getRepo(qr, Payment);
//     const historyRepo = this._getRepo(qr, PaymentHistory);
...
//       logger.warn(
//         `[PaymentService] Partial debt deduction: only ${actualDebtDeducted} of ${roundedDeduction} deducted. Worker: ${workerId}`
//       );
//     }
//     }
