 ...
 */
module.exports = class InitSchema1781627663082 {
    name = 'InitSchema1781627663082'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "debt_payments" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "amount" decimal(10,2) NOT NULL DEFAULT (0), "previousBalance" decimal(10,2) NOT NULL DEFAULT (0), "newBalance" decimal(10,2) NOT NULL DEFAULT (0), "notes" varchar, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "deletedAt" datetime, "paymentId" integer, "debtId" integer, CONSTRAINT "UQ_DEBT_PAYMENT_PAYMENT_DEBT" UNIQUE ("paymentId", "debtId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_DEBT_PAYMENT_PAYMENT" ON "debt_payments" ("paymentId") `);
        await queryRunner.query(`CREATE INDEX "IDX_DEBT_PAYMENT_DEBT" ON "debt_payments" ("debtId") `);
        await queryRunner.query(`CREATE INDEX "IDX_DEBT_PAYMENT_CREATED" ON "debt_payments" ("createdAt") `);
        await queryRunner.query(`CREATE TABLE "debt_histories" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "amountPaid" decimal(10,2) NOT NULL DEFAULT (0), "previousBalance" decimal(10,2) NOT NULL DEFAULT (0), "newBalance" decimal(10,2) NOT NULL DEFAULT (0), "transactionType" varchar NOT NULL DEFAULT ('payment'), "paymentMethod" varchar, "referenceNumber" varchar, "notes" varchar, "transactionDate" datetime NOT NULL DEFAULT (datetime('now')), "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "deletedAt" datetime, "debtId" integer)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_debts" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "originalAmount" decimal(10,2) NOT NULL DEFAULT (0), "amount" decimal(10,2) NOT NULL DEFAULT (0), "reason" varchar, "balance" decimal(10,2) NOT NULL DEFAULT (0), "status" varchar CHECK( "status" IN ('pending','partially_paid','paid','cancelled','overdue','settled') ) NOT NULL DEFAULT ('pending'), "dateIncurred" datetime NOT NULL DEFAULT (datetime('now')), "dueDate" datetime, "paymentTerm" varchar, "interestRate" decimal(5,2) NOT NULL DEFAULT (0), "totalInterest" decimal(10,2) NOT NULL DEFAULT (0), "totalPaid" decimal(10,2) NOT NULL DEFAULT (0), "lastPaymentDate" datetime, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "deletedAt" datetime, "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "interestCalculationPeriod" varchar CHECK( "interestCalculationPeriod" IN ('per_annum','per_month') ) NOT NULL DEFAULT ('per_annum'), "lastInterestAccrualDate" datetime, "workerId" integer, "sessionId" integer NOT NULL, CONSTRAINT "FK_911db2b833aff4711b124e4cd91" FOREIGN KEY ("workerId") REFERENCES "workers" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_4c60ffbc7da02dbb731adb900e7" FOREIGN KEY ("sessionId") REFERENCES "sessions" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_debts"("id", "originalAmount", "amount", "reason", "balance", "status", "dateIncurred", "dueDate", "paymentTerm", "interestRate", "totalInterest", "totalPaid", "lastPaymentDate", "createdAt", "deletedAt", "updatedAt", "interestCalculationPeriod", "lastInterestAccrualDate", "workerId", "sessionId") SELECT "id", "originalAmount", "amount", "reason", "balance", "status", "dateIncurred", "dueDate", "paymentTerm", "interestRate", "totalInterest", "totalPaid", "lastPaymentDate", "createdAt", "deletedAt", "updatedAt", "interestCalculationPeriod", "lastInterestAccrualDate", "workerId", "sessionId" FROM "debts"`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_DEBT_WORKER" ON "debts" ("workerId") `);
        await queryRunner.query(`CREATE INDEX "IDX_DEBT_SESSION" ON "debts" ("sessionId") `);
        await queryRunner.query(`DROP INDEX "IDX_DEBT_PAYMENT_PAYMENT"`);
        await queryRunner.query(`DROP INDEX "IDX_DEBT_PAYMENT_DEBT"`);
        await queryRunner.query(`DROP INDEX "IDX_DEBT_PAYMENT_CREATED"`);
        await queryRunner.query(`CREATE TABLE "temporary_debt_payments" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "amount" decimal(10,2) NOT NULL DEFAULT (0), "previousBalance" decimal(10,2) NOT NULL DEFAULT (0), "newBalance" decimal(10,2) NOT NULL DEFAULT (0), "notes" varchar, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "deletedAt" datetime, "paymentId" integer, "debtId" integer, CONSTRAINT "UQ_DEBT_PAYMENT_PAYMENT_DEBT" UNIQUE ("paymentId", "debtId"), CONSTRAINT "FK_3f311c96f8b40886a31557dae38" FOREIGN KEY ("paymentId") REFERENCES "payments" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_d2a2d5006c00bb3998be54ec542" FOREIGN KEY ("debtId") REFERENCES "debts" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_debt_payments"("id", "amount", "previousBalance", "newBalance", "notes", "createdAt", "deletedAt", "paymentId", "debtId") SELECT "id", "amount", "previousBalance", "newBalance", "notes", "createdAt", "deletedAt", "paymentId", "debtId" FROM "debt_payments"`);
        await queryRunner.query(`DROP TABLE "debt_payments"`);
        await queryRunner.query(`ALTER TABLE "temporary_debt_payments" RENAME TO "debt_payments"`);
        await queryRunner.query(`CREATE INDEX "IDX_DEBT_PAYMENT_PAYMENT" ON "debt_payments" ("paymentId") `);
        await queryRunner.query(`CREATE INDEX "IDX_DEBT_PAYMENT_DEBT" ON "debt_payments" ("debtId") `);
        await queryRunner.query(`CREATE INDEX "IDX_DEBT_PAYMENT_CREATED" ON "debt_payments" ("createdAt") `);
        await queryRunner.query(`DROP INDEX "IDX_DEBT_HISTORY_DATE"`);
        await queryRunner.query(`DROP INDEX "IDX_DEBT_HISTORY_TYPE"`);
        await queryRunner.query(`CREATE TABLE "temporary_debt_histories" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "amountPaid" decimal(10,2) NOT NULL DEFAULT (0), "previousBalance" decimal(10,2) NOT NULL DEFAULT (0), "newBalance" decimal(10,2) NOT NULL DEFAULT (0), "transactionType" varchar NOT NULL DEFAULT ('payment'), "paymentMethod" varchar, "referenceNumber" varchar, "notes" varchar, "transactionDate" datetime NOT NULL DEFAULT (datetime('now')), "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "deletedAt" datetime, "debtId" integer, CONSTRAINT "FK_b28e0e3c07469b9e12c2473adbb" FOREIGN KEY ("debtId") REFERENCES "debts" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_debt_histories"("id", "amountPaid", "previousBalance", "newBalance", "transactionType", "paymentMethod", "referenceNumber", "notes", "transactionDate", "createdAt", "deletedAt", "debtId") SELECT "id", "amountPaid", "previousBalance", "newBalance", "transactionType", "paymentMethod", "referenceNumber", "notes", "transactionDate", "createdAt", "deletedAt", "debtId" FROM "debt_histories"`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_payments" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "grossPay" decimal(10,2) NOT NULL DEFAULT (0), "manualDeduction" decimal(10,2) DEFAULT (0), "netPay" decimal(10,2) NOT NULL DEFAULT (0), "status" varchar CHECK( "status" IN ('pending','partially_paid','completed','cancelled') ) NOT NULL DEFAULT ('pending'), "paymentDate" datetime, "paymentMethod" varchar, "referenceNumber" varchar, "periodStart" datetime, "periodEnd" datetime, "totalDebtDeduction" decimal(10,2) NOT NULL DEFAULT (0), "otherDeductions" decimal(10,2) NOT NULL DEFAULT (0), "deductionBreakdown" json, "notes" varchar, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "deletedAt" datetime, "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "idempotencyKey" varchar, "amountPaid" decimal(10,2) NOT NULL DEFAULT (0), "lastPaymentDate" datetime, "debtDeductionTotal" decimal(10,2) NOT NULL DEFAULT (0), "workerId" integer, "pitakId" integer, "sessionId" integer NOT NULL, "assignmentId" integer, CONSTRAINT "FK_a03c9d5254fca3435262af9721c" FOREIGN KEY ("workerId") REFERENCES "workers" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_8bedf6595ab5a0ea80a6e008cff" FOREIGN KEY ("pitakId") REFERENCES "pitaks" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_c96a63d98681cc603f7300deeb5" FOREIGN KEY ("sessionId") REFERENCES "sessions" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_dd4f81603d259c9f00994f8bbec" FOREIGN KEY ("assignmentId") REFERENCES "assignments" ("id") ON DELETE SET NULL ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_payments"("id", "grossPay", "manualDeduction", "netPay", "status", "paymentDate", "paymentMethod", "referenceNumber", "periodStart", "periodEnd", "totalDebtDeduction", "otherDeductions", "deductionBreakdown", "notes", "createdAt", "deletedAt", "updatedAt", "idempotencyKey", "amountPaid", "lastPaymentDate", "debtDeductionTotal", "workerId", "pitakId", "sessionId", "assignmentId") SELECT "id", "grossPay", "manualDeduction", "netPay", "status", "paymentDate", "paymentMethod", "referenceNumber", "periodStart", "periodEnd", "totalDebtDeduction", "otherDeductions", "deductionBreakdown", "notes", "createdAt", "deletedAt", "updatedAt", "idempotencyKey", "amountPaid", "lastPaymentDate", "debtDeductionTotal", "workerId", "pitakId", "sessionId", "assignmentId" FROM "payments"`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "payments" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "grossPay" decimal(10,2) NOT NULL DEFAULT (0), "manualDeduction" decimal(10,2) DEFAULT (0), "netPay" decimal(10,2) NOT NULL DEFAULT (0), "status" varchar CHECK( "status" IN ('pending','partially_paid','completed','cancelled') ) NOT NULL DEFAULT ('pending'), "paymentDate" datetime, "paymentMethod" varchar, "referenceNumber" varchar, "periodStart" datetime, "periodEnd" datetime, "totalDebtDeduction" decimal(10,2) NOT NULL DEFAULT (0), "otherDeductions" decimal(10,2) NOT NULL DEFAULT (0), "deductionBreakdown" json, "notes" varchar, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "deletedAt" datetime, "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "idempotencyKey" varchar, "amountPaid" decimal(10,2) NOT NULL DEFAULT (0), "lastPaymentDate" datetime, "debtDeductionTotal" decimal(10,2) NOT NULL DEFAULT (0), "workerId" integer, "pitakId" integer, "sessionId" integer NOT NULL, "assignmentId" integer)`);
        await queryRunner.query(`INSERT INTO "payments"("id", "grossPay", "manualDeduction", "netPay", "status", "paymentDate", "paymentMethod", "referenceNumber", "periodStart", "periodEnd", "totalDebtDeduction", "otherDeductions", "deductionBreakdown", "notes", "createdAt", "deletedAt", "updatedAt", "idempotencyKey", "amountPaid", "lastPaymentDate", "debtDeductionTotal", "workerId", "pitakId", "sessionId", "assignmentId") SELECT "id", "grossPay", "manualDeduction", "netPay", "status", "paymentDate", "paymentMethod", "referenceNumber", "periodStart", "periodEnd", "totalDebtDeduction", "otherDeductions", "deductionBreakdown", "notes", "createdAt", "deletedAt", "updatedAt", "idempotencyKey", "amountPaid", "lastPaymentDate", "debtDeductionTotal", "workerId", "pitakId", "sessionId", "assignmentId" FROM "temporary_payments"`);
        ...
        await queryRunner.query(`DROP INDEX "IDX_DEBT_PAYMENT_DEBT"`);
        await queryRunner.query(`DROP INDEX "IDX_DEBT_PAYMENT_PAYMENT"`);
        await queryRunner.query(`ALTER TABLE "debt_payments" RENAME TO "temporary_debt_payments"`);
        await queryRunner.query(`CREATE TABLE "debt_payments" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "amount" decimal(10,2) NOT NULL DEFAULT (0), "previousBalance" decimal(10,2) NOT NULL DEFAULT (0), "newBalance" decimal(10,2) NOT NULL DEFAULT (0), "notes" varchar, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "deletedAt" datetime, "paymentId" integer, "debtId" integer, CONSTRAINT "UQ_DEBT_PAYMENT_PAYMENT_DEBT" UNIQUE ("paymentId", "debtId"))`);
        await queryRunner.query(`INSERT INTO "debt_payments"("id", "amount", "previousBalance", "newBalance", "notes", "createdAt", "deletedAt", "paymentId", "debtId") SELECT "id", "amount", "previousBalance", "newBalance", "notes", "createdAt", "deletedAt", "paymentId", "debtId" FROM "temporary_debt_payments"`);
        await queryRunner.query(`DROP TABLE "temporary_debt_payments"`);
        await queryRunner.query(`CREATE INDEX "IDX_DEBT_PAYMENT_CREATED" ON "debt_payments" ("createdAt") `);
        await queryRunner.query(`CREATE INDEX "IDX_DEBT_PAYMENT_DEBT" ON "debt_payments" ("debtId") `);
        await queryRunner.query(`CREATE INDEX "IDX_DEBT_PAYMENT_PAYMENT" ON "debt_payments" ("paymentId") `);
        await queryRunner.query(`DROP INDEX "IDX_DEBT_SESSION"`);
        ...
        await queryRunner.query(`CREATE TABLE "debts" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "originalAmount" decimal(10,2) NOT NULL DEFAULT (0), "amount" decimal(10,2) NOT NULL DEFAULT (0), "reason" varchar, "balance" decimal(10,2) NOT NULL DEFAULT (0), "status" varchar CHECK( "status" IN ('pending','partially_paid','paid','cancelled','overdue','settled') ) NOT NULL DEFAULT ('pending'), "dateIncurred" datetime NOT NULL DEFAULT (datetime('now')), "dueDate" datetime, "paymentTerm" varchar, "interestRate" decimal(5,2) NOT NULL DEFAULT (0), "totalInterest" decimal(10,2) NOT NULL DEFAULT (0), "totalPaid" decimal(10,2) NOT NULL DEFAULT (0), "lastPaymentDate" datetime, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "deletedAt" datetime, "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "interestCalculationPeriod" varchar CHECK( "interestCalculationPeriod" IN ('per_annum','per_month') ) NOT NULL DEFAULT ('per_annum'), "lastInterestAccrualDate" datetime, "workerId" integer, "sessionId" integer NOT NULL)`);
        await queryRunner.query(`INSERT INTO "debts"("id", "originalAmount", "amount", "reason", "balance", "status", "dateIncurred", "dueDate", "paymentTerm", "interestRate", "totalInterest", "totalPaid", "lastPaymentDate", "createdAt", "deletedAt", "updatedAt", "interestCalculationPeriod", "lastInterestAccrualDate", "workerId", "sessionId") SELECT "id", "originalAmount", "amount", "reason", "balance", "status", "dateIncurred", "dueDate", "paymentTerm", "interestRate", "totalInterest", "totalPaid", "lastPaymentDate", "createdAt", "deletedAt", "updatedAt", "interestCalculationPeriod", "lastInterestAccrualDate", "workerId", "sessionId" FROM "temporary_debts"`);
