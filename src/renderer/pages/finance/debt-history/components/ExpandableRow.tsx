// src/renderer/pages/finance/debt-history/components/ExpandableRow.tsx
import React, { useState } from "react";
import { ChevronDown, ChevronUp, Copy } from "lucide-react";
import type { DebtHistoryWithDetails } from "../types";

interface ExpandableRowProps {
  item: DebtHistoryWithDetails;
          ...
          <td colSpan={100} className="px-4 py-3">
            <div className="text-sm">
              <div className="flex justify-between items-start mb-2">
                <span className="font-medium text-[var(--text-secondary)]">Additional Details</span>
                <button
