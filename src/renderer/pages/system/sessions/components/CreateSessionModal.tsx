...
const CreateSessionModal: React.FC<Props> = ({ isOpen, onClose, onSuccess, initialData }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={initialData?.id ? "Edit Session" : "Add Session"} size="md">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium text-[var(--text-secondary)] mb-1">Season Type</label>
          <select
