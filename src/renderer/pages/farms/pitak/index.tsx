  ...
  return (
    <div className="p-6 space-y-4">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-[var(--text-primary)]">Plot Management</h1>
          <p className="text-sm text-[var(--text-secondary)] mt-1">Manage all plots (pitak) and their assigned workers</p>
        </div>
      ...
      <div className="bg-[var(--card-bg)] rounded-xl p-4 border border-[var(--border-color)] space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <BukidSelect
            ...
            onChange={(id) => { setBukidId(id || undefined); setPage(1); }}
